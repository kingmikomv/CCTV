    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="javascript:void(0)" class="menu-link menu-toggle">
                ...
                <div data-i18n="User interface">Produk</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="{{route('kategoriProduk')}}" class="menu-link">
                        <div data-i18n="Kategori Produk">Kategori Produk</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="/stok-produk" class="menu-link">
                        <div data-i18n="Stok Produk">Stok Produk</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="/satuan-produk" class="menu-link">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="forms-basic-inputs.html" class="menu-link">
                        <div data-i18n="Basic Inputs">Pemasangan Baru</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="forms-input-groups.html" class="menu-link">
                        <div data-i18n="Input groups">Gangguan</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="forms-basic-inputs.html" class="menu-link">
                        <div data-i18n="Basic Inputs">Akun</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="forms-input-groups.html" class="menu-link">
                        <div data-i18n="Input groups">Pengaturan Web</div>
                    </a>
                </li>
            </ul>
        </li>
